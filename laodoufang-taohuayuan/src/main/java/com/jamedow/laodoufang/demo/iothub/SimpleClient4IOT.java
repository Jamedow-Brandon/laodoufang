 ...
 */
package com.jamedow.laodoufang.demo.iothub;
...
public class SimpleClient4IOT {
    ...
    /******这里是客户端需要的参数*******/
    public static String deviceName = "taohuayuan_device_001";
    public static String productKey = "a1x9EkyqXrN";
    public static String secret = "4cvkwUGfyi67CmT4o9Y0NiLwK9yxy7Se";
