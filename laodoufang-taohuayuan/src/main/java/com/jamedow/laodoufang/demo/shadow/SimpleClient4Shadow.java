package com.jamedow.laodoufang.demo.shadow;

import com.alibaba.fastjson.JSON;
import com.alibaba.fastjson.JSONObject;
import com.jamedow.laodoufang.util.AliyunWebUtils;
import com.jamedow.laodoufang.util.LogUtil;
import com.jamedow.laodoufang.util.SignUtil;
...
public class SimpleClient4Shadow {
     ...
     * 设备key和secret信息
     */
    private static String deviceName = "taohuayuan_device_001";
    private static String productKey = "a1x9EkyqXrN";
    private static String deviceSecret = "4cvkwUGfyi67CmT4o9Y0NiLwK9yxy7Se";
    ...
    private static SSLSocketFactory createSSLSocket() throws Exception {
        ...
        context.init(null, new TrustManager[]{new com.jamedow.laodoufang.demo.iothub.ALiyunIotX509TrustManager()}, null);
